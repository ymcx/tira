...
Huomaa että annettu koodi käyttää tässä tarkoituksessa oletusarvoisesti taulukkototeutusta. Jos haluat sen käyttävän linkitettyä listaa, joudut muuttamaan koodia metodissa `PhoneBookBase.getCoders`. 
